            ...
            <div className="container-fluid pt-5" >
                ...
                <div className="card-deck pl-5  pr-5 d-flex justify-content-center ">
                    ...
                    <div className="card border border-gold h-100 shadow p-3 mb-5 bg-white rounded">
                        ...
                        <div className="h-25">
                            <h5 className="card-title title-font text-center ">Title</h5>
                           ...
                           <div className="h-50 ">
                                ...
                                <p className="text-center warning">90/100</p>
                            </div>
                            <div className="d-flex flex-row justify-content-center">
                          
                            <a href="#" class="card-link justify-content-center gold-font">Start Quiz</a>
